...
3. Ask the agent a concrete question with model name, units, region names, step names, and intended evidence.
4. Review the proposed contract before authorizing model edits or solver execution.
5. Preserve logs and outputs needed to distinguish static checks, solver status, and physical review.
